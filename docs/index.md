...
hero:
  name: QwikAuth
  text: Authentication for Qwik City!
  ...
  actions:
    ...
    - theme: alt
      text: GitHub
      link: https://github.com/zitadel/qwik-auth

features:
  - title: OAuth
    details: Effortlessly connect your Qwik City application with Google, GitHub, Azure and countless others.
  ...
  - title: Made for Qwik City
    details: Deep integrations with the Qwik City framework.
